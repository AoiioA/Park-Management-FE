            ...
            >
              ...
              <template slot="items" slot-scope="props">
                ...
                <td class="text-xs-center">
                  <v-btn flat icon small color="primary" class="ma-0" :to="{ name: 'contract-detail', query: { contractType: 'expired' }, params: { contractId: props.item.id } }">
